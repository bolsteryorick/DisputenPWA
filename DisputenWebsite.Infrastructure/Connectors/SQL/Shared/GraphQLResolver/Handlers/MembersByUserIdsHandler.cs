...
{
    public class MembersByUserIdsHandler : IRequestHandler<MembersByUserIdsRequest, MembersByUserIdsResult>
    {
        ...
        public async Task<MembersByUserIdsResult> Handle(MembersByUserIdsRequest request, CancellationToken cancellationToken)
        {
            return new MembersByUserIdsResult(
                await ResolveMembersByUserIds(request.UserIds, request.Helper, cancellationToken)
                );
        }
