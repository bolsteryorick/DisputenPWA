...
namespace DisputenPWA.API.GraphQL.ResultTypes
{
    public class UserResultType : ObjectGraphType<User>
    {
        public UserResultType()
        {
            ...
            Field(f => f.Memberships, nullable: true, type: typeof(ListGraphType<MemberResultType>)).Description("The group memberships of this user.");
            Field(f => f.Attendences, nullable: true, type: typeof(ListGraphType<AttendeeResultType>)).Description("The group memberships of this user.");
            Field(f => f.Contacts, nullable: true, type: typeof(ListGraphType<ContactResultType>)).Description("The contacts of this user.");
        }
    }
}